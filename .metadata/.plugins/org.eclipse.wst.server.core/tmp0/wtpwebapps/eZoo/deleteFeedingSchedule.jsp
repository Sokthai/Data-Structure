...
<!-- 	Just some stuff you need -->
	...
	%>
		...
		<form method="post" action="deleteFeedingSchedule">
			...
			<table class="table table-striped table-hover table-responsive ezoo-datatable">
				 ...
				 -->
					<c:forEach var="FeedingSchedule" items="${FeedingSchedules}">
						<tr>
							...
							<td><input type="checkbox" name="deleteFs" value=<c:out value="${FeedingSchedule.scheduleID}" />></td>
						</tr>
					</c:forEach>
		    	...
		    	<div class="col-sm-1">
		      		<button type="submit" class="btn btn-primary">Remove Schedule</button>
		    	</div>
		  	</div>
