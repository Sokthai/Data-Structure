                ...
                <ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a href="addFeedingSchedule">Add Feeding Schedule</a></li>
                          <li><a href="assignFeedingSchedule">Assign Feeding Schedules</a></li>
                          <li><a href="deleteFeedingSchedule">Delete Feeding Schedules</a></li>
                          <li><a href="updateFeedingSchedule">Update Feeding Schedules</a></li>
                          <li><a href="listassignanimal">List Assigned Animals</a></li>
                          <li><a href="listunassignanimal">List Unassigned Animals</a></li>
